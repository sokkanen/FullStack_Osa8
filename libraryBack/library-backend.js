...
const resolvers = {
    ...
    Mutation: {
      ...
      editAuthor: (root, args) => {
        ...
        const modifiedAuthor = {...author, born: args.born}
        authors = authors.map(a => a.name === modifiedAuthor.name ? modifiedAuthor : a)
    ...
    Query: {
      bookCount: (root, args) => {
          ...
          const filteredBooks = books.filter(b => b.author === args.name)
